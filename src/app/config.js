...
.run(function(oauth2Service, menuService, $state, $rootScope, $location, authUrl, $window, userService) {
    ...
    oauth2Service.clientId = "1xoLA2XQIOacqXcW45rdZ35C8tXaioAPxsEHUWY5"; //PG in heroku
    ...
    $rootScope.$on('$stateChangeSuccess', function() {
        ...
        console.log("$stateChangeSuccess getIdentityClaims=" + oauth2Service.getIdentityClaims());
        ...
        console.log("nonce="+localStorage.getItem("nonce"));
